...
export type { ElDrawerOpenOptions, ElDrawerSide, ElDrawerSize } from './drawer.token';
export { EL_DRAWER, EL_DRAWER_DATA } from './drawer.token';
export { ElDrawerClose } from './drawer-close';
...
@Component({
  ...
  providers: [{ provide: EL_DRAWER, useExisting: ElDrawer }],
  host: {
    class: 'el-drawer-host',
    '(document:keydown.escape)': 'onEscape($event)',
  },
})
export class ElDrawer implements ElDrawerContext {
  ...
  private readonly uid = ElDrawer.nextId++;
  readonly titleId = `el-drawer-title-${this.uid}`;
