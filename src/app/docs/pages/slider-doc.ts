...
export class MyComponent {}`;
  ...
  protected readonly rangeCode = `<el-slider
  range
  [(start)]="minPrice"
  [(end)]="maxPrice"
  [step]="5"
...
/>`;
  ...
  protected readonly statesCode = `<el-slider [value]="45" disabled showValue ariaLabel="Disabled" />
<el-slider [value]="20" error showValue ariaLabel="Amount" />`;
  ...
  protected readonly props: PropDefinition[] = [
    ...
    },
    {
      ...
      description: 'Accessible name for the range lower thumb.',
    },
    {
      name: 'ariaLabelEnd',
      type: 'string',
      default: "'Maximum value'",
      description: 'Accessible name for the range upper thumb.',
    },
    {
      name: 'orientation',
      type: "'horizontal' | 'vertical'",
      default: "'horizontal'",
      description: 'Exposed on thumbs via aria-orientation.',
    },
  ];
}
